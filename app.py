...
def fetch_and_analyze_v32_5(ticker):
    try:
        ...
        # 核心修正：水底(MACD<0)但斜率轉正(hist今日>昨日)給7分；多頭順風給10分
...
with st.sidebar:
    ...
    st.divider()
    st.markdown("<div style='color:#888; font-size:0.8rem;'>當前版本：V32.5 巔峰全修正版</div>", unsafe_allow_html=True)

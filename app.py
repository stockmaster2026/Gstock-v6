...
# --- 1. 核心數據獲取 (V32.5：MACD 斜率先行修正 + 抗鎖頻快取) ---
@st.cache_data(ttl=3600, show_spinner=False)
def fetch_v32_5_data(ticker):
    try:
        # 抗封鎖延時：抓取 60 檔必須模擬真人休息，這是防止跑不出來的關鍵

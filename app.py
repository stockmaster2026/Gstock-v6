...
# --- 1. 核心數據核心 (V32.5 修正：MACD 斜率先行 + 終極分流防斷) ---
@st.cache_data(ttl=3600, show_spinner=False)
def fetch_v32_5_stable(ticker):
    try:
        # 防斷機制：每一檔抓取隨機休息 1.5~3 秒，分散壓力
        ...
        return {
            ...
            "s": round((a1 * 0.25 + a2 * 0.30 + a3 * 0.45), 1), "a1": a1, "a2": a2, "a3": a3,
